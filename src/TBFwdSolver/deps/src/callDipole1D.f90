!======================================================================
! `callDipole1D` calculates all electrical components excited by dipole 
!  source.
!
!
!======================================================================
subroutine callDipole1D(txLoc, rxLoc, freqArray, sigma1D, depth1D, &
	...
	! conductivity structure, depth of top of layer
    ...
    !
    ! store the conductivity at the site location for later use.
...
!======================================================================
! `callDipoleEB` computes specific component of electromagnetic fields 
! excited by electric dipole source.
!
! -compFlag indicates user-defined component
!
!======================================================================
...
!======================================================================
! `callDipole1DFinite` computes specific component of electromagnetic  
! fields excited by long-wire source.
! 
!======================================================================
subroutine callDipole1DFinite(txLoc, rxLoc, dipLen, nP, freqArray, sigma1D, &
                            depth1D, nTx, nRx, nFreq, nZ, compFlag, pred1D)
